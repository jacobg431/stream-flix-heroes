...
-- 2) Recreate database
DROP DATABASE IF EXISTS "StreamFlix_TestDB";
CREATE DATABASE "StreamFlix_TestDB" OWNER test_user;

GRANT CONNECT ON DATABASE "StreamFlix_TestDB" TO test_user;

-- 3) Connect to it (psql only)
\c "StreamFlix_TestDB"
